...
function _determineSync(local, remoteFile, remoteStats, remoteLastSync) {
	...
	if (action==API.__UNKNOWN) {
		...
		var difftime = local.lastSyncTime - remoteStats.mtime;
		if (Math.abs(difftime)<120 || difftime<0) {
